...
var Dajaxice = {
    ...
    execeuteCAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('sampleapp.execeuteCAjax', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    call: function(dajaxice_function, method, dajaxice_callback, argv, custom_settings)
    {
        ...
        var send_data = 'argv='+encodeURIComponent(JSON.stringify(argv)),
            ...
            endpoint = '/sampleapp/dajaxice/'+dajaxice_function+'/';
